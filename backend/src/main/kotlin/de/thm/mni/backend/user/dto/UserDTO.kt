...
@Schema(description = "Internal user profile or external mail contact.")
data class UserDTO(
    @field:Schema(description = "User identifier.", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED)
    val id: UUID,
...
fun User.toDTO() = UserDTO(
    id = requireNotNull(this.id) { "Cannot map a user without an identifier" },
